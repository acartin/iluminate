...
export async function POST(request: Request) {
  ...
  if (placeholderAuthEnabled) {
    return redirectWithFeedback("info", `Placeholder mode: ${String(payload.label ?? "role")} was not saved to the database.`);
  }
  ...
  return redirectWithFeedback("success", "Role created successfully.");
}
