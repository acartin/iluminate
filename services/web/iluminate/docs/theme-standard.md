# Iluminate Theme Standard

This document defines how Iluminate standardizes theme configuration on top of `shadcn/ui` and Tailwind, using the same visual system as the reference portal so compatible theme updates can be applied with minimal friction.
...
### 3.2 Iluminate extension tokens
...
2. Derive Iluminate extension tokens from that palette.
