...
export function AppShell({
  ...
  useEffect(() => {
    setSidebarCollapsed(localStorage.getItem("iluminate-sidebar") === "collapsed");
    setFocusMode(localStorage.getItem("iluminate-focus-mode") === "enabled");
  }, []);

  useEffect(() => {
    localStorage.setItem("iluminate-sidebar", sidebarCollapsed ? "collapsed" : "expanded");
  }, [sidebarCollapsed]);

  useEffect(() => {
    localStorage.setItem("iluminate-focus-mode", focusMode ? "enabled" : "disabled");
  }, [focusMode]);
