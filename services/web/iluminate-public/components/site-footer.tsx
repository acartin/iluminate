...
export function SiteFooter() {
  return (
    <footer className="site-footer">
      <Link className="footer-brand-link" href="/" aria-label="Iluminate — Inicio">
        <Image className="footer-brand" src={wordmark} alt="" width={120} height={60} unoptimized />
      </Link>
      <div className="footer-grid">
        <div>
          <span className="eyebrow">Contáctenos</span>
          <a className="footer-contact-link" href="https://wa.me/50684041002">
            <span className="footer-contact-icon footer-contact-whatsapp"><WhatsAppIcon /></span>
            +506 8404 1002
          </a>
          <a className="footer-contact-link" href="mailto:acartin@datasyncsa.com">
            <span className="footer-contact-icon footer-contact-mail"><MailIcon /></span>
            acartin@datasyncsa.com
          </a>
        </div>
        <div>
